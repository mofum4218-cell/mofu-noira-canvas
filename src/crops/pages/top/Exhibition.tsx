...
import noiraLiquidConfig from "@/config/pages/noira-liquid.json"; // ← 追加！
...
export const Exhibition: React.FC = () => {
  return (
    <Grid>
      ...
      <GalleryCard id={noiraLiquidConfig.id} title={noiraLiquidConfig.title} subtitle={noiraLiquidConfig.subtitle} /> {/* ← 追加！ */}
    </Grid>
  );
};
